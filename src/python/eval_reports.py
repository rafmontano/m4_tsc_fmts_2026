...
# Purpose:
#   Shared Python-to-R evaluation bridge.
#   Python models predict labels; R computes metrics and saves consolidated outputs.
#   Used by sktime, Chronos, and Mantis experiment runners.
...
def store_r_real_result(containers, horizon_id: int, res_real, series_name=None):
    _ensure_r_loaded()
...
def save_r_consolidated_eval_object(eval_obj, eval_rds_path: str, window_mode: str = "default"):
    _ensure_r_loaded()
