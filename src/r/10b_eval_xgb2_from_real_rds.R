...
# Consolidated evaluation script for XGBoost
#
# For each frequency and window mode it:
#   1) evaluates all saved horizon models on the internal test split
#   2) reads the precomputed REAL last-window evaluation dataset
#   3) evaluates all saved horizon models on the REAL dataset
#   4) saves into one single consolidated RDS per frequency under:
#       small / default / large
#
# Assumes:
#   - 10a has already created:
#       data/real_eval_with_features_<tag>_<window_tag>.rds
# =====================================================================
