...
#
# Purpose:
#   Build critical-difference inputs and diagrams from real-evaluation accuracy.
# Inputs:
#   Consolidated model-evaluation RDS files under results.
# Outputs:
#   Critical-difference tables and figures for each window mode.
# Run from:
#   Project root.
# ==============================================================================
...
# Build CD diagrams by window mode -------------------------------------------
