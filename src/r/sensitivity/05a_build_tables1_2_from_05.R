...
#
# Build Tables 1 and 2 from the sensitivity pipeline.
#
# Sources:
#   - Script 05: Naive2, FFORMA, SMYL, Chronos-2, SMYL-Oracle,
#                SMYL-Mantis and Chronos-2-Mantis
#   - Script 04: standalone Mantis terminal-horizon DA
#
# TABLE 1
#   Daily results:
#   sMAPE, MASE, terminal-horizon DA, OWA,
#   and improvement relative to SMYL.
#
# TABLE 2
#   Panel A: terminal-horizon DA
#   Panel B: full-horizon OWA
...
# ---------------------------------------------------------------------
# 3. Select best lambda pair for each adjusted method
#
...
# ---------------------------------------------------------------------
# 4. Select point-forecast baseline rows
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# 5. Standalone Mantis terminal-horizon DA
#
...
# ---------------------------------------------------------------------
# 6. Selected results for the six M4 frequencies
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# 8. Complete selected-results dataset
# ---------------------------------------------------------------------
